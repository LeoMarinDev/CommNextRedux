// Control build: same asset set as BuildCommNextReduxUIBundle, but a DISTINCT bundle name so the
...
public static class BuildCommNextReduxControl
{
    private const string BundleName = "commnextredux_ui_broken.bundle";
