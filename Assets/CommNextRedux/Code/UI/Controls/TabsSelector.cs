...
// Origin: mods-outdated/CommNext/src/CommNext.Unity/CommNext.Unity/Assets/Runtime/Controls/TabsSelector.cs (CommNext v0.7.0, MIT).
...
//   complete. DIVERGENCE: the legacy file's `using JetBrains.Annotations;` was removed - it
//   was unused (no attribute from it appears in the file) and the namespace does not exist
//   in a Unity-only project, so it was a CS0246 waiting to happen in the bundle project.
