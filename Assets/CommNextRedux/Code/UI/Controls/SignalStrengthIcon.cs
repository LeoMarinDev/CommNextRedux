...
// Origin: mods-outdated/CommNext/src/CommNext.Unity/CommNext.Unity/Assets/Runtime/Controls/SignalStrengthIcon.cs (CommNext v0.7.0, MIT).
...
//
// Used by Assets/CommNextRedux/UI/Components/NetworkConnectionView.uxml
//   as <CommNext.Unity.Runtime.Controls.SignalStrengthIcon>.
...
namespace CommNext.Unity.Runtime.Controls
{
    ...
    public class SignalStrengthIcon : VisualElement
    {
        public new class UxmlTraits : VisualElement.UxmlTraits
        {
            ...
            // markup's name="signal-strength-icon" is silently dropped and the lookup returns null.
